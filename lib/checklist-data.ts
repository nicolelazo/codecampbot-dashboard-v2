...
export const CHECKLIST_TEMPLATE: Record<string, ChecklistTemplateItem[]> = {
  ...
  legazpi: [
    ...
    { tCode: 'W-2',    task: 'Whitelist Required Websites — sui.io, suiscan.xyz, github.com, vercel.app, youtube.com, docs.google.com',                         date: 'Jul 16, 2026', status: 'done' },
    ...
    { tCode: 'W-2',    task: 'Slides Preparation — prepare and finalize all presentation slides; ensure all links and embedded materials are working; test demos', date: 'Jul 16, 2026', status: 'done' },
    { tCode: 'W-2',    task: 'Mentor Requirements — mentor training done Jul 13, 2026 ✓; finalize the 10 mentor names; submit Sui smart contract as proof of learning', date: 'Jul 16, 2026', status: 'pending' },
    { tCode: 'W-2',    task: 'Merch Shipment — shipped via LBC; en route to IDS Colleges before event day',                                                       date: 'Jul 16, 2026', status: 'done' },
    { tCode: 'W-2',    task: 'First Dry Run — check overall flow and technical issues; test internet stability, audio/visual setup, and facilitator coordination', date: 'Jul 16, 2026', status: 'done' },
    ...
    { tCode: 'T-0 ☻', task: 'EVENT DAY — Legazpi Code Camp · Jul 30, 2026 · IDS Colleges',                                                                     date: 'Jul 30, 2026', status: 'upcoming', isEvent: true },
    { tCode: 'T+2',    task: 'Post-Event Promotional Materials — create and publish posts; upload photos/videos and participant highlights; coordinate with partner schools', date: 'Aug 1, 2026',  status: 'pending' },
    { tCode: 'T+5',    task: 'Post-Code Camp Report (EOD) — include participant profile, attendees count, projects submitted, highlights, photos/videos, social media posts', date: 'Aug 4, 2026',  status: 'pending' },
  ...
  cdo: [
    ...
    { tCode: 'W-2',    task: 'Whitelist Required Websites — sui.io, suiscan.xyz, github.com, vercel.app, youtube.com, docs.google.com',                         date: 'Jul 15, 2026', status: 'done' },
    ...
    { tCode: 'W-2',    task: 'Slides Preparation — prepare and finalize all presentation slides; ensure all links and embedded materials are working; test demos', date: 'Jul 15, 2026', status: 'done' },
    { tCode: 'W-2',    task: 'Mentor Requirements — mentor training done Jul 13, 2026 ✓ (low turnout); only 5 mentors confirmed so far — recruit/finalize 10 before event day; submit Sui smart contract as proof of learning', date: 'Jul 15, 2026', status: 'pending' },
    { tCode: 'W-2',    task: 'Merch Shipment — shipped via LBC; en route to DICT Region-X before event day',                                                       date: 'Jul 15, 2026', status: 'done' },
    { tCode: 'W-2',    task: 'First Dry Run — check overall flow and technical issues; test internet stability, audio/visual setup, and facilitator coordination', date: 'Jul 15, 2026', status: 'done' },
    ...
    { tCode: 'T-0 ☻', task: 'EVENT DAY — CDO Code Camp · Jul 29, 2026 · DICT Region-X · BYOD setup · 30–40 pax',                                               date: 'Jul 29, 2026', status: 'upcoming', isEvent: true },
    { tCode: 'T+2',    task: 'Post-Event Promotional Materials — create and publish posts; upload photos/videos and participant highlights; coordinate with partner schools', date: 'Jul 31, 2026', status: 'pending' },
    { tCode: 'T+5',    task: 'Post-Code Camp Report (EOD) — include participant profile, attendees count, projects submitted, highlights, photos/videos, social media posts', date: 'Aug 3, 2026',  status: 'pending' },
    { tCode: 'T+7',    task: 'Liquidation — collect and organize all receipts; submit complete liquidation report; ensure all supporting documents are complete', date: 'Aug 5, 2026',  status: 'pending' },
  ],
}
