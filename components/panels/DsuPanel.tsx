      ...
      <div>
        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            { icon: '🟡', title: 'No-shows — Registration ≠ Attendance', color: '#f59e0b', border: 'rgba(245,158,11,0.25)', bg: 'rgba(245,158,11,0.06)', body: 'Registration numbers do not guarantee attendance. Mitigation: excused class rule creates real penalty; guides sent via email keep registrants engaged pre-event.', owner: 'MITIGATION: Excused class rule + email engagement guides' },
            { icon: '🟡', title: 'Sir Florence Unresponsive — PUP Coordination', color: '#f59e0b', border: 'rgba(245,158,11,0.25)', bg: 'rgba(245,158,11,0.06)', body: 'Primary PUP contact unresponsive. Bypassed by working directly with PUP org advisers. All decisions now documented in writing.', owner: 'MITIGATION: Direct PUP org adviser coordination · Everything in writing' },
            { icon: '🟡', title: 'Traffic / Laguna Logistics', color: '#f59e0b', border: 'rgba(245,158,11,0.25)', bg: 'rgba(245,158,11,0.06)', body: 'Laguna travel time and gate access are risk factors. Start time adjusted to 7 PM. Guest access and front gate registration flow must be confirmed so PUP students are not stuck outside.', owner: 'ACTION: Confirm guest access + front gate registration flow for PUP students' },
          ].map(r => (
